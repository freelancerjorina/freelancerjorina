...
<Variable name="keycolor" description="Main Color" type="color" default="$(main.color)" value="#2874f0"/>
...
<Group description="Theme Colors" selector="body">
 <Variable name="main.color" description="Main Theme Color" type="color" default="#2874f0" value="#2874f0"/>
  <Variable name="main.dark.color" description="Dark Color" type="color" default="#111111" value="#111111"/>
  <Variable name="header.bg" description="Header Background" type="color" default="#2874f0" value="#2874f0"/>
  <Variable name="header.color" description="Header Color" type="color" default="#ffffff" value="#ffffff"/>
  <Variable name="menu.bg" description="Menu Background" type="color" default="#172337" value="#172337"/>
  ...
  <Variable name="title.hover" description="Title Color on Hover" type="color" default="$(main.color)" value="#2874f0"/>
...
<Group description="Theme Body" selector="body">
  ...
  <Variable name="body.link.color" description="Link Color" type="color" default="$(main.color)"  value="#2874f0"/>
</Group>
...
<Variable name="posts.icons.color" description="Post icons color" hideEditor="true" type="color" default="$(main.color)"  value="#2874f0"/>
<Variable name="labels.background.color" description="Label background color" hideEditor="true" type="color" default="$(main.color)"  value="#2874f0"/>
*/
...
body#layout .sora-panel #LinkList69, body#layout .sora-panel #LinkList1,body#layout .sora-panel #LinkList2{width:100%;margin-right:0}
...
body#layout div.header-logo{float:left;width:35%;height:auto;max-width:none;max-height:none}
...
body#layout .vertical-left-menu, body#layout #main-slider-wrapper, body#layout .vertical-right-menu {
    width: 33.33%;
    float: left;
}
...
<!-- Theme Options -->
  <div class='theme-options' style='display:none'>
    <b:section class='sora-panel' id='sora-panel' maxwidgets='5' name='Theme Options' showaddelement='no'>
 ...
 <b:if cond='data:link.name == &quot;shippingOption&quot;'>
      ...
      <b:widget id='LinkList1' locked='true' title='Upi Options' type='LinkList' version='2' visible='true'>
        <b:widget-settings>
          <b:widget-setting name='sorting'>NONE</b:widget-setting>
          <b:widget-setting name='text-1'>PhonePe</b:widget-setting>
          <b:widget-setting name='link-1'>https://3.bp.blogspot.com/-j6N4WB840Nk/XvnYTEiTdXI/AAAAAAAAI2M/sdB9pyCx37Qg6e9S5lyadOaSdR9J4A3XQCK4BGAYYCw/s1600/PhonePe-Payment.png</b:widget-setting>
          <b:widget-setting name='text-0'>Paytm</b:widget-setting>
          <b:widget-setting name='link-2'>https://2.bp.blogspot.com/-cZKn3fLqmc4/XvnYTPzSpaI/AAAAAAAAI2I/HfgprPnb4qUPOz1gis56LlqxyPVN1ONLACK4BGAYYCw/s1600/Gpay-Payment.png</b:widget-setting>
          <b:widget-setting name='link-0'>https://2.bp.blogspot.com/-fzbq0b2gQyM/XvnYTLYan9I/AAAAAAAAI2E/Ab4Jefs7RUszZWT-DC3QrTpLR7W6IOnBgCK4BGAYYCw/s1600/Paytm-Payment.png</b:widget-setting>
          <b:widget-setting name='text-2'>Gpay</b:widget-setting>
        </b:widget-settings>
        <b:includable id='main'>
  <b:include name='widget-title'/>
  <b:include name='content'/>
 ...
 <div class='widget-content'>
   <ul>
     <b:loop values='data:links' var='link'>
      ...
      <b:widget id='LinkList2' locked='true' title='Bank Details' type='LinkList' version='2' visible='true'>
        <b:widget-settings>
          <b:widget-setting name='link-3'>Soratemplates</b:widget-setting>
          <b:widget-setting name='sorting'>NONE</b:widget-setting>
          <b:widget-setting name='link-4'>1223 9238 9999</b:widget-setting>
          <b:widget-setting name='text-1'>Branch:</b:widget-setting>
          <b:widget-setting name='link-1'>Bank Branch</b:widget-setting>
          <b:widget-setting name='text-0'>Bank Name:</b:widget-setting>
          <b:widget-setting name='link-2'>ABC1220</b:widget-setting>
          <b:widget-setting name='text-3'>Account:</b:widget-setting>
          <b:widget-setting name='link-0'>American Bank</b:widget-setting>
          <b:widget-setting name='text-2'>Branch Code:</b:widget-setting>
    ...
    <div class='header-header'>    
      <div class='container row'>
          <b:section class='header-logo' id='header-logo' maxwidgets='1' name='Header Logo' showaddelement='yes'>
            <b:widget id='Header1' locked='true' title='AMAR DOKAN (Header)' type='Header' version='2' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='displayUrl'>http://3.bp.blogspot.com/-w1WmLW2Q9qQ/X0yyrpI-FQI/AAAAAAAAJQI/spE-AOSP8mkjfTX4obssSgNeGr9iqR1bQCK4BGAYYCw/s1600/sora-shop.png</b:widget-setting>
...
<!-- Top Social --> 
        <b:section class='top-bar-social social' id='top-bar-social' maxwidgets='1' name='Social Top' showaddelement='yes'>
           <b:widget id='LinkList73' locked='true' title='Top Social' type='LinkList' version='2' visible='true'>
             <b:widget-settings>
          ...
          <b:section class='right-menu' id='right-menu' maxwidgets='1' name='Header Right Menu' showaddelement='yes'>
            <b:widget id='LinkList72' locked='true' title='Top Menu' type='LinkList' version='2' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='sorting'>NONE</b:widget-setting>
                <b:widget-setting name='text-1'><![CDATA[<i class="fa fa-phone"></i> +1-202-555-0114]]></b:widget-setting>
                <b:widget-setting name='link-1'>#</b:widget-setting>
                <b:widget-setting name='text-0'><![CDATA[<i class="fa fa-envelope"></i> support@soracart.com]]></b:widget-setting>
                <b:widget-setting name='link-2'>#</b:widget-setting>
                <b:widget-setting name='link-0'>#</b:widget-setting>
                <b:widget-setting name='text-2'><![CDATA[<i class="fa fa-whatsapp"></i> 202-555-0123]]></b:widget-setting>
              </b:widget-settings>
              <b:includable id='main'>
                <b:include name='content'/>
              </b:includable>
        ...
        <b:section class='main-menu' id='main-menu' maxwidgets='1' name='Main Menu' showaddelement='yes'>
          <b:widget id='LinkList74' locked='true' title='Link List' type='LinkList' version='2' visible='true'>
            <b:widget-settings>
              ...
              <b:widget-setting name='link-1'>#</b:widget-setting>
              <b:widget-setting name='link-2'>#</b:widget-setting>
              <b:widget-setting name='link-12'>http://www.soratemplates.com/2020/08/sorashop-blogger-templates.html</b:widget-setting>
              <b:widget-setting name='link-0'>/</b:widget-setting>
              <b:widget-setting name='link-11'>https://youtu.be/SQW-mCGnLXo</b:widget-setting>
              <b:widget-setting name='link-10'>https://www.sorabloggingtips.com/2020/08/how-to-setup-sorashop-blogger-template.html</b:widget-setting>
              ...
              <b:widget-setting name='link-8'>https://sorashop-soratemplates.blogspot.com/soratemplates</b:widget-setting>
              <b:widget-setting name='link-5'>#</b:widget-setting>
              <b:widget-setting name='link-6'>https://sorashop-soratemplates.blogspot.com/p/post-format-and-page-markup.html</b:widget-setting>
              <b:widget-setting name='link-3'>#</b:widget-setting>
...
<div class='container row'>
  <b:section class='second-menu' id='second-menu' maxwidgets='1' name='Secondary Menu' showaddelement='yes'>
    <b:widget id='LinkList3' locked='true' title='' type='LinkList' visible='true'>
      <b:widget-settings>
        <b:widget-setting name='text-9'>About Us</b:widget-setting>
        <b:widget-setting name='link-9'>https://sorashop-soratemplates.blogspot.com/p/about.html</b:widget-setting>
        <b:widget-setting name='text-8'>Contact Us</b:widget-setting>
        <b:widget-setting name='link-7'>#</b:widget-setting>
        <b:widget-setting name='link-8'>https://sorashop-soratemplates.blogspot.com/p/contact-us.html</b:widget-setting>
        ...
        <b:widget-setting name='text-5'><![CDATA[Today's Deals]]></b:widget-setting>
...
<div class='container row'>
<b:section class='author-list right-side-widget' id='intro-services-right' maxwidgets='8' name='Product Services' showaddelement='no'>
  <b:widget id='Image21' locked='true' title='Free Shipping' type='Image' version='2' visible='true'>
    <b:widget-settings>
      <b:widget-setting name='displayUrl'>http://4.bp.blogspot.com/--deLFnouCw8/X0y2DxnObpI/AAAAAAAAJQ0/cLa2tWFymPwzryBCpBY3Myc_PunQX-kfACK4BGAYYCw/s1600/truck.png</b:widget-setting>
      <b:widget-setting name='displayHeight'>40</b:widget-setting>
      <b:widget-setting name='sectionWidth'>150</b:widget-setting>
      <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
  ...
  <b:widget id='Image22' locked='true' title='24/7 Support' type='Image' version='2' visible='true'>
    <b:widget-settings>
      <b:widget-setting name='displayUrl'>http://3.bp.blogspot.com/-P0Om4NmB9Os/X0y2NMGIAXI/AAAAAAAAJQ8/tdXBSMrtPZwJYoOHmOUJO-vOxqP5s3odwCK4BGAYYCw/s1600/headphones.png</b:widget-setting>
      <b:widget-setting name='displayHeight'>40</b:widget-setting>
      <b:widget-setting name='sectionWidth'>150</b:widget-setting>
      <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
      <b:widget-setting name='displayWidth'>40</b:widget-setting>
  ...
  <b:widget id='Image23' locked='true' title='Quick Payment' type='Image' version='2' visible='true'>
    <b:widget-settings>
      <b:widget-setting name='displayUrl'>http://3.bp.blogspot.com/-E1DowojxRNQ/X0y2VoZCE3I/AAAAAAAAJRI/I6lhaGUdNyEoREEkB8epFmqFwD0XLOleACK4BGAYYCw/s1600/wallet.png</b:widget-setting>
      <b:widget-setting name='displayHeight'>40</b:widget-setting>
      <b:widget-setting name='sectionWidth'>150</b:widget-setting>
      <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
      <b:widget-setting name='displayWidth'>40</b:widget-setting>
  ...
  <b:widget id='Image24' locked='true' title='Gift Coupons' type='Image' version='2' visible='true'>
    <b:widget-settings>
      <b:widget-setting name='displayUrl'>http://2.bp.blogspot.com/-Q1rerr-Mxpg/X0y2cN37HfI/AAAAAAAAJRQ/M0YGXxod4GE-dd79NKzB8q1DnJPwYxMuQCK4BGAYYCw/s1600/gift.png</b:widget-setting>
      <b:widget-setting name='displayHeight'>40</b:widget-setting>
      <b:widget-setting name='sectionWidth'>150</b:widget-setting>
      <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
      <b:widget-setting name='displayWidth'>40</b:widget-setting>
                ...
                <div class='product-header'>
                  <div class='col-left'>
                    <div class='post-image-wrap item_image'>
                      <b:if cond='data:post.featuredImage'> 
                        <img class='post-thumb item_thumb' expr:alt='data:post.title' expr:src='data:post.featuredImage.isYouTube ? resizeImage(data:post.featuredImage.youtubeMaxResDefaultUrl.jsonEscaped, 72, &quot;1:1&quot;) : resizeImage(data:post.featuredImage, 72, &quot;1:1&quot;)'/>
                        <b:else/>
 ...
 &quot;publisher&quot;: {
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML1' locked='false' title='Subscribe Us' type='HTML' visible='true'>
            <b:widget-settings>
        ...
        <b:loop values='data:labels' var='label'>
          ...
          <b:widget id='Label4' locked='false' title='Tags' type='Label' visible='true'>
            <b:widget-settings>
              ...
              <b:widget-setting name='selectedLabelsList'>kids,laptop,mens,mobile,smartwatch,store,women</b:widget-setting>
              <b:widget-setting name='showType'>USER_SELECTED</b:widget-setting>
...
<b:if cond='data:view.isHomepage'>
  <div id='brand-services-wrap'>
      <div class='container row'>
        <b:section id='intro-brand' maxwidgets='5' name='Brand Logos' showaddelement='no'>
          <b:widget id='LinkList78' locked='true' title='Brand Icons' type='LinkList' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='link-5'>#</b:widget-setting>
              <b:widget-setting name='link-3'>#</b:widget-setting>
              <b:widget-setting name='link-4'>#</b:widget-setting>
              <b:widget-setting name='text-1'>https://1.bp.blogspot.com/-khnFa3KCdhI/X0y9vGPplLI/AAAAAAAAJSM/1hKSWYRMC6Et7u5IyuJxLWnn3I0RH2FOwCNcBGAsYHQ/s1600/brand-2.png</b:widget-setting>
              <b:widget-setting name='text-0'>https://1.bp.blogspot.com/-iGf0_AmsNy0/X0y9vD1e5vI/AAAAAAAAJSI/WuKjQvc1Tp0ULeJdzM4ylnHbxSoAIZeJQCNcBGAsYHQ/s1600/brand-1.png</b:widget-setting>
              <b:widget-setting name='text-3'>https://1.bp.blogspot.com/-8X9NbPmBSCE/X0y9wKBzY4I/AAAAAAAAJSU/0hjkPr2Lfy4JxmKNImVcvoZ69ZAhtIEBwCNcBGAsYHQ/s1600/brand-4.png</b:widget-setting>
              <b:widget-setting name='text-2'>https://1.bp.blogspot.com/-JtAtVv3CnE0/X0y9vE_O97I/AAAAAAAAJSQ/KtT9ogRF-102rGjJAU7nDR378NiGrAWFACNcBGAsYHQ/s1600/brand-3.png</b:widget-setting>
              <b:widget-setting name='text-5'>https://1.bp.blogspot.com/-ki14mkqCya8/X0y9wUGsKVI/AAAAAAAAJSc/Md2Ut5JWS0gCio2KeagNFzSpS3DQIeQxACNcBGAsYHQ/s1600/brand-6.png</b:widget-setting>
              <b:widget-setting name='text-4'>https://1.bp.blogspot.com/-24EK6w4MNN4/X0y9wWpGkOI/AAAAAAAAJSY/Ap5xCw_AIpkRlBTdKDwj09OrfePY2wGvQCNcBGAsYHQ/s1600/brand-5.png</b:widget-setting>
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
              <b:widget-setting name='link-1'>#</b:widget-setting>
              <b:widget-setting name='link-2'>#</b:widget-setting>
              <b:widget-setting name='link-0'>#</b:widget-setting>
...
&lt;style type=&#39;text/css&#39;&gt;
                ...
                <ul>
                  <b:loop values='data:links' var='link'>
                    <li expr:class='data:link.target'><img expr:src='data:link.name' target='_blank'/></li>
                  </b:loop>
                </ul>
              </div>
            </b:includable>
  ...
  <div class='container row'>
    <div class='footer-widgets-wrap'>
      <b:section class='footer common-widget' id='footer-sec1' maxwidgets='3' name='Section (Left)' showaddelement='yes'>
        <b:widget id='Label5' locked='false' title='Tags' type='Label' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='sorting'>FREQUENCY</b:widget-setting>
            <b:widget-setting name='display'>CLOUD</b:widget-setting>
            <b:widget-setting name='selectedLabelsList'>kids,laptop,mens,mobile,smartwatch,women</b:widget-setting>
            <b:widget-setting name='showType'>USER_SELECTED</b:widget-setting>
            <b:widget-setting name='showFreqNumbers'>true</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main' var='this'>
  ...
  <b:loop values='data:labels' var='label'>
    <span class='label-size'>
      ...
      <b:section class='footer common-widget' id='footer-sec2' maxwidgets='3' name='Section (Center)' showaddelement='yes'>
        <b:widget id='PopularPosts2' locked='false' title='Most Popular' type='PopularPosts' visible='true'>
          <b:widget-settings>
...
<div class='clearfix'/>
  <b:if cond='data:blog.url != data:blog.canonicalHomepageUrl + &quot;p/cart.html&quot;'>
...
<textarea class='soracustomform-message contact-style' name='order notes' placeholder='Order Notes *' value=''/>
<textarea class='contact-form-email-message contact-style' id='ContactForm1_contact-form-email-message' name='email-message' placeholder='Message *' rows='5'/>
...
<input id='sora-bank' name='payment_method' type='radio' value='banktransfer'/>
                            <span>Bank Transfer <img src='http://3.bp.blogspot.com/-uyVMdNWi2LQ/XvDwK6N90yI/AAAAAAAAIzs/z9QxTyWYMQgmJcdzmjKvdZemMyusxQvkgCK4BGAYYCw/s400/banktransfer.png'/></span>
                          </label>
</li>
</ul>
  </div>
...
<p class='sorathanks'>Thank <span class='soranamesuccess'/>. We received your oder.
              <a class='printsora' href='javascript:void(0)'><i class='fa fa-print'/></a>
</p>
...
<td class='ccountry'/>
  ...
  <b:section class='hidden-widgets' id='hidden-widgets' maxwidgets='1' name='Important But Hidden Widgets' showaddelement='no'>
